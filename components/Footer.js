        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex space-x-4">
              <a href="#" className="text-grey hover:text-gold transition-colors duration-300">
          ...
          {/* Legal */}
          <div>
            <h4 className="font-nav font-semibold text-white mb-4">Legal</h4>
            <ul className="space-y-2">
        ...
        <div className="border-t border-grey-dark pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex items-center space-x-4 mt-4 md:mt-0">
              <span className="text-grey text-sm">Powered by</span>
              <div className="flex items-center space-x-2">
                <div className="w-4 h-4 bg-gold rounded-sm"></div>
                <span className="text-gold font-nav font-semibold text-sm">Premium Data</span>
              </div>
            </div>
          </div>
        </div>
