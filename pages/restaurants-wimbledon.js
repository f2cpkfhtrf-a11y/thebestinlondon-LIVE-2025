...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Wimbledon","Wimbledon Village"];
...
export default function WimbledonRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Wimbledon 2025",
    "description": "Directory of top-rated restaurants in Wimbledon",
    "url": "https://www.thebestinlondon.co.uk/restaurants-wimbledon",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Wimbledon 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Wimbledon with real Google ratings.`} />
