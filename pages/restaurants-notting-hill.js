...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Notting Hill","Portobello","Ladbroke Grove"];
...
export default function NottingHillRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Notting Hill 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Notting Hill with real Google ratings.`} />
