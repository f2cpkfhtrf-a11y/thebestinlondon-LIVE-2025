...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Stratford","Westfield","Olympic Park"];
...
export default function StratfordRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Stratford 2025",
    "description": "Directory of top-rated restaurants in Stratford",
    "url": "https://thebestinlondon.co.uk/restaurants-stratford",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Stratford 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Stratford with real Google ratings.`} />
