...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Borough","London Bridge","Bermondsey"];
...
export default function BoroughRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Borough 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Borough with real Google ratings.`} />
