...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Clerkenwell","Farringdon","Exmouth Market"];
...
export default function ClerkenwellRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Clerkenwell 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Clerkenwell with real Google ratings.`} />
