...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Hackney","Dalston","London Fields"];
...
export default function HackneyRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Hackney 2025",
    "description": "Directory of top-rated restaurants in Hackney",
    "url": "https://thebestinlondon.co.uk/restaurants-hackney",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Hackney 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Hackney with real Google ratings.`} />
