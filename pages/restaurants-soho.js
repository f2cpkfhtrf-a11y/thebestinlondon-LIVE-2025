...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Soho","Leicester Square","Piccadilly"];
...
export default function SohoRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Soho 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Soho with real Google ratings.`} />
