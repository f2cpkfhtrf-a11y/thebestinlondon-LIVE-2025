...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Central London","West End","Covent Garden","Soho","Mayfair","Marylebone","Bloomsbury","Fitzrovia"];
    ...
    return { 
      props: { 
        ...
        area: 'Central London',
        description: 'Discover the best restaurants in Central London, from West End theatres to Covent Garden markets.'
      },
      revalidate: 3600
    };
  } catch (error) {
    ...
    return { 
      props: { 
        venues: [],
        area: 'Central London',
        description: 'Discover the best restaurants in Central London.'
      },
      revalidate: 3600
    };
  }
...
export default function RestaurantsCentralLondon({ venues, area, description }) {
  ...
  return (
    <>
      <Head>
        <title>Best Restaurants in Central London | The Best in London</title>
        <meta name="description" content={description} />
        <meta name="keywords" content="restaurants, central london, west end, covent garden, soho, mayfair, dining" />
      </Head>
