...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Camden","Camden Town","Chalk Farm"];
...
export default function CamdenRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Camden 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Camden with real Google ratings.`} />
