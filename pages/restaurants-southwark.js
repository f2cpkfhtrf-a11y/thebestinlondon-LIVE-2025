...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Southwark","Borough","London Bridge","Bermondsey","Elephant and Castle","Peckham","Camberwell"];
    ...
    return { 
      props: { 
        ...
        area: 'Southwark',
        description: 'Discover the best restaurants in Southwark, from Borough Market to London Bridge.'
      },
      revalidate: 3600
    };
  } catch (error) {
    ...
    return { 
      props: { 
        venues: [],
        area: 'Southwark',
        description: 'Discover the best restaurants in Southwark.'
      },
      revalidate: 3600
    };
  }
...
export default function RestaurantsSouthwark({ venues, area, description }) {
  ...
  return (
    <>
      <Head>
        <title>Best Restaurants in Southwark | The Best in London</title>
        <meta name="description" content={description} />
        <meta name="keywords" content="restaurants, southwark, borough market, london bridge, bermondsey, dining" />
      </Head>
