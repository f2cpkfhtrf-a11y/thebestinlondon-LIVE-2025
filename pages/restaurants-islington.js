...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Islington","Angel","Upper Street"];
...
export default function IslingtonRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Islington 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Islington with real Google ratings.`} />
