...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Bethnal Green","Cambridge Heath"];
...
export default function BethnalGreenRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Bethnal Green 2025",
    "description": "Directory of top-rated restaurants in Bethnal Green",
    "url": "https://thebestinlondon.co.uk/restaurants-bethnal-green",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Bethnal Green 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Bethnal Green with real Google ratings.`} />
