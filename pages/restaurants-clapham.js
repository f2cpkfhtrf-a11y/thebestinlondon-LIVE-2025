...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Clapham","Clapham Junction","Battersea"];
...
export default function ClaphamRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Clapham 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Clapham with real Google ratings.`} />
