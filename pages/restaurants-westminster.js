...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Westminster","Parliament","Trafalgar Square","St James's","Victoria","Pimlico","Belgravia"];
    ...
    return { 
      props: { 
        ...
        area: 'Westminster',
        description: 'Discover the best restaurants in Westminster, from Parliament to Trafalgar Square.'
      },
      revalidate: 3600
    };
  } catch (error) {
    ...
    return { 
      props: { 
        venues: [],
        area: 'Westminster',
        description: 'Discover the best restaurants in Westminster.'
      },
      revalidate: 3600
    };
  }
...
export default function RestaurantsWestminster({ venues, area, description }) {
  ...
  return (
    <>
      <Head>
        <title>Best Restaurants in Westminster | The Best in London</title>
        <meta name="description" content={description} />
        <meta name="keywords" content="restaurants, westminster, parliament, trafalgar square, st james, victoria, dining" />
      </Head>
