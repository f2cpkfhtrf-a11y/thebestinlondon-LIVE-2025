...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Mayfair","Berkeley Square","Grosvenor Square"];
...
export default function MayfairRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Mayfair 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Mayfair with real Google ratings.`} />
