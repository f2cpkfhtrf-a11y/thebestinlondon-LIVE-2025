...
export default function WhitechapelRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Whitechapel 2025",
    "description": "Directory of top-rated restaurants in Whitechapel",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Whitechapel 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Whitechapel with real Google ratings.`} />
      ...
      <header style={{ background: 'linear-gradient(135deg, #10b981 0%, #059669 100%)', color: 'white', padding: '60px 20px' }}>
        <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
          <h1 style={{ fontSize: '48px', fontWeight: '800', margin: '0 0 16px 0' }}>
            Best Restaurants in Whitechapel
          </h1>
