// /[stationSlug] - Individual station page with radius filter
  ...
  return (
    <>
      <Head>
        ...
        />
        <link rel="canonical" href={`https://thebestinlondon.co.uk/${station.slug}`} />
        <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
          ...
          "url": `https://thebestinlondon.co.uk/${station.slug}`
        }) }} />
      </Head>
      ...
      <div style={{ minHeight: '100vh', background: theme.colors.bg.primary, color: theme.colors.text.primary }}>
        ...
        <nav style={{
          ...
          <div style={{ maxWidth: '1200px', margin: '0 auto', padding: '0 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            <Link href="/halal-near-stations-simple" style={{
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', padding: `${theme.spacing.md} 20px` }}>
          <nav style={{ fontSize: '0.875rem', color: theme.colors.text.secondary }}>
            ...
            <Link href="/halal-near-stations-simple" style={{ color: theme.colors.text.secondary, textDecoration: 'none' }}>Halal Near Stations</Link>
            <span style={{ margin: '0 0.5rem' }}>›</span>
