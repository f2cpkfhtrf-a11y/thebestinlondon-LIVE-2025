...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Kings Cross","St Pancras","Granary Square"];
...
export default function KingsCrossRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Kings Cross 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Kings Cross with real Google ratings.`} />
