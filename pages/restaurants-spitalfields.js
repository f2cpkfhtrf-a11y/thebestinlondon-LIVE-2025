...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Spitalfields","Brick Lane","Liverpool Street"];
...
export default function SpitalfieldsRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Spitalfields 2025",
    "description": "Directory of top-rated restaurants in Spitalfields",
    "url": "https://thebestinlondon.co.uk/restaurants-spitalfields",
    "mainEntity": {
      "@type": "ItemList",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Spitalfields 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Spitalfields with real Google ratings.`} />
