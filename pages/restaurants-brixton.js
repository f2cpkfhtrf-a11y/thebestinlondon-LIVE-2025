...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Brixton","Stockwell","Herne Hill"];
...
export default function BrixtonRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Brixton 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Brixton with real Google ratings.`} />
