...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Covent Garden","Seven Dials","Drury Lane"];
...
export default function CoventGardenRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Covent Garden 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Covent Garden with real Google ratings.`} />
