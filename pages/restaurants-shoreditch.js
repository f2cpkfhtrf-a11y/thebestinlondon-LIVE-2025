...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Shoreditch","Hackney","Old Street"];
...
export default function ShoreditchRestaurants({ venues, lastUpdated }) {
  ...
  const schemaData = {
    ...
    "@type": "CollectionPage",
    "name": "Best Restaurants in Shoreditch 2025",
    "description": "Directory of top-rated restaurants in Shoreditch",
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Shoreditch 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Shoreditch with real Google ratings.`} />
