...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Fitzrovia","Charlotte Street","Goodge Street"];
...
export default function FitzroviaRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Fitzrovia 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Fitzrovia with real Google ratings.`} />
