...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Chelsea","Kings Road","Sloane Square"];
...
export default function ChelseaRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Chelsea 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Chelsea with real Google ratings.`} />
