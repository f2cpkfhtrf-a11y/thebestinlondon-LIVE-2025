...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Bloomsbury","Russell Square","British Museum"];
...
export default function BloomsburyRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Bloomsbury 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Bloomsbury with real Google ratings.`} />
