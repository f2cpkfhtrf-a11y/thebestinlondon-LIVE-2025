...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Richmond","Richmond Park","Kew"];
...
export default function RichmondRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Richmond 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Richmond with real Google ratings.`} />
