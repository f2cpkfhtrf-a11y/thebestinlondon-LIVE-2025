...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Greenwich","Cutty Sark","Greenwich Park"];
...
export default function GreenwichRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Greenwich 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Greenwich with real Google ratings.`} />
