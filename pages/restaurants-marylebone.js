...
export async function getStaticProps() {
  ...
  try {
    ...
    const keywords = ["Marylebone","Baker Street","Marylebone High Street"];
...
export default function MaryleboneRestaurants({ venues, lastUpdated }) {
  ...
  return (<>
    <Head>
      <title>Best Restaurants in Marylebone 2025 - {venues.length} Top Rated | The Best in London</title>
      <meta name="description" content={`Discover ${venues.length} best restaurants in Marylebone with real Google ratings.`} />
