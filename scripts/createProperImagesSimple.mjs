...
// Food-specific designs for cuisines (without emojis)
...
// Area-specific designs for London areas (without emojis)
const AREA_DESIGNS = {
  'camden': {
    ...
    const svgContent = `
      <svg width="1920" height="1080" viewBox="0 0 1920 1080" xmlns="http://www.w3.org/2000/svg">
        ...
        <g transform="translate(960, 540)">
          <!-- Food Icon -->
          <text x="0" y="-120" text-anchor="middle" font-family="Arial, sans-serif" font-size="80" font-weight="bold" fill="white" filter="url(#shadow)">
            ${design.icon}
          </text>
